  ...
  function createChatCard(persona, message, isProof, proofAmount, timestamp) {
    ...
    if (isProof) {
      ...
      proofHtml = `<div class="chat-proof-card">
        <img src="${proofImageUrl}" alt="Withdrawal Proof" style="max-width:100%; height:auto; border-radius:12px; display:block;" onerror="this.style.display='none'">
      </div>`;
    }
