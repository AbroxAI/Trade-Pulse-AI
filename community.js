(function() {
      ...
      <div class="section" style="margin-top:0;">
        ...
        <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:16px; background:linear-gradient(135deg, rgba(168,85,247,.08), rgba(0,0,0,.2)); border-radius:16px; padding:14px;">
          ...
          <div style="display:flex; align-items:center; gap:8px; flex-shrink:0;">
            <div style="display:flex; align-items:center;" id="heroAvatarStackInline"></div>
            <div>
        ...
        <!-- Filter Tabs -->
        <div style="display:flex; gap:6px; margin-bottom:12px; overflow-x:auto;" id="filterTabsInlineContainer">
          <!-- Filled by JS -->
        </div>
  ...
  function switchToWinsProofs() {
    ...
    // Rebuild the entire content (hero, KPI, filters, list)
