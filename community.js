(function() {
  ...
  function setActiveTab(tabElement) {
    ...
    if (tabElement === tabWinsProofs) {
      // Show Wins & Proofs, hide chat and sidebar
  ...
  // Global function for the sidebar card
  ...
  // Live injection and updates (also refreshes inline list if visible)
  ...
  function startCommunitySimulation() {
    ...
    updateOnlineMembers();
    updateSidebarWithdrawals();
    // Pre-render the inline list and hero avatar stack (will be used when tab is opened)
