(function() {
  ...
  function buildWinsProofsContent() {
    ...
    document.getElementById('winsProofsBackBtn')?.addEventListener('click', () => {
      ...
      document.querySelector('.community-pinned').style.display = 'flex';
      document.getElementById('communityInputBar').style.display = 'flex';
    });
  }
  ...
  function renderLiveWithdrawalListInline() {
    ...
    document.getElementById('kpiSuccessfulInline').textContent = filtered.length;
  ...
  // ========== ANNOUNCEMENTS FEED FOR MARKET UPDATES ==========
  const announcements = [
    {
      id: 1,
      title: "Spot Market Closing Summary",
      description: "Markets closed with strong bullish momentum. BTC gained 3.2%, ETH up 2.8%. USDT pairs saw record volume. Tomorrow’s session opens at 08:00 UTC. Prepare your strategies accordingly.",
      date: "Jun 27, 2026 · 4:15 PM",
      image: "assets/announcements/announcement1.jpg",
      reactions: { "👍": 84, "❤️": 32, "🔥": 18, "🚀": 15 }
    },
    {
      id: 2,
      title: "BTC/USDT Breakout Alert",
      description: "Bitcoin just broke above the $72,500 resistance. Analysts expect continuation to $74,200. Stay cautious with leverage and use tight stop losses.",
      date: "Jun 27, 2026 · 10:30 AM",
      image: "assets/announcements/announcement2.jpg",
      reactions: { "👍": 127, "❤️": 45, "🔥": 33, "🎯": 21 }
    },
    {
      id: 3,
      title: "VIP Signal Performance Report",
      description: "Our VIP signals delivered a 92% win rate this week with an average profit of 145 pips. Congratulations to all VIP members! Premium and VIP plans are open for new members.",
      date: "Jun 26, 2026 · 6:00 PM",
      image: "assets/announcements/announcement3.jpg",
      reactions: { "👍": 203, "❤️": 89, "🥳": 55, "💎": 32 }
    },
    {
      id: 4,
      title: "New Trading Pairs Added",
      description: "SOL/USDT and AVAX/USDT are now available for trading on our platform. Enjoy competitive spreads and instant execution.",
      date: "Jun 25, 2026 · 2:20 PM",
      image: "assets/announcements/announcement4.jpg",
      reactions: { "👍": 96, "❤️": 38, "🎉": 19, "💹": 14 }
    },
    {
      id: 5,
      title: "System Maintenance Notice",
      description: "We will perform scheduled maintenance on June 28, 2026 from 02:00–04:00 UTC. Trading will be temporarily paused. Withdrawals remain unaffected.",
      date: "Jun 24, 2026 · 11:00 AM",
      image: "assets/announcements/announcement5.jpg",
      reactions: { "👍": 54, "❤️": 12, "🔧": 25, "⏳": 8 }
    },
    {
      id: 6,
      title: "EUR/USD Analysis",
      description: "EUR/USD found support at 1.0650. A potential rebound toward 1.0720 is expected if the ECB minutes remain hawkish. Manage risk accordingly.",
      date: "Jun 24, 2026 · 9:45 AM",
      image: "assets/announcements/announcement6.jpg",
      reactions: { "👍": 78, "❤️": 27, "📊": 34, "🤔": 11 }
    },
    {
      id: 7,
      title: "Monthly Profit Distribution",
      description: "June profit share of $1.2M has been distributed among eligible investors. Check your wallet for the credit. Thank you for your trust!",
      date: "Jun 23, 2026 · 5:30 PM",
      image: "assets/announcements/announcement7.jpg",
      reactions: { "👍": 312, "❤️": 176, "💰": 134, "🥂": 67 }
    },
    {
      id: 8,
      title: "Referral Program Update",
      description: "Earn 5% commission for every friend you invite. Top referrer this month received $4,200 in bonuses. Share your link now!",
      date: "Jun 22, 2026 · 3:15 PM",
      image: "assets/announcements/announcement8.jpg",
      reactions: { "👍": 143, "❤️": 58, "👥": 41, "💸": 39 }
    },
    {
      id: 9,
      title: "Security Enhancement",
      description: "We’ve upgraded our encryption to SHA-256 with 2FA biometric verification. Your funds and data are safer than ever.",
      date: "Jun 21, 2026 · 12:00 PM",
      image: "assets/announcements/announcement9.jpg",
      reactions: { "👍": 189, "❤️": 94, "🔐": 76, "🛡️": 52 }
    },
    {
      id: 10,
      title: "Market Outlook Q3 2026",
      description: "Our analysts forecast a bullish Q3 with possible new ATHs for major pairs. Inflation data and Fed policy will be key drivers.",
      date: "Jun 20, 2026 · 4:00 PM",
      image: "assets/announcements/announcement10.jpg",
      reactions: { "👍": 267, "❤️": 102, "📈": 89, "🌍": 44 }
    },
    {
      id: 11,
      title: "GBP/USD Technical Outlook",
      description: "Cable remains range‑bound between 1.2450 and 1.2600. A breakout above 1.2600 could target 1.2750. FOMC minutes later this week.",
      date: "Jun 19, 2026 · 10:10 AM",
      image: "assets/announcements/announcement11.jpg",
      reactions: { "👍": 65, "❤️": 23, "📉": 17, "👀": 29 }
    },
    {
      id: 12,
      title: "Weekend Trading Schedule",
      description: "Markets will be closed this Saturday and Sunday. Regular trading resumes Monday 00:00 UTC. Use this time to review your portfolio.",
      date: "Jun 18, 2026 · 6:45 PM",
      image: "assets/announcements/announcement12.jpg",
      reactions: { "👍": 34, "❤️": 11, "📅": 20, "⏸️": 7 }
    }
  ];
  ...
  function renderAnnouncements() {
    ...
    if (!container) {
      ...
      // Insert after the tabs section (or after community-tabs)
  ...
  // ========== SWITCH TO WINS & PROOFS (unchanged) ==========
  ...
  // ========== SWITCH TO MARKET UPDATES (Announcements) ==========
  ...
  document.querySelector('.community-quick-ico.blue')?.closest('.community-quick-card')?.addEventListener('click', switchToMarketUpdates);

  // Inject new live withdrawal (unchanged)
