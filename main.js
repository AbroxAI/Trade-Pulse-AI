(function() {
  ...
  // Payment not detected modal (for both deposit & invest)
  ...
  $('confirmDepositBtn')?.addEventListener('click', () => {
    ...
    setTimeout(() => {
      hideProcessing();
      // Show Palmpay payment modal with correct details
  ...
  $('confirmInvestBtn')?.addEventListener('click', () => {
    ...
    setTimeout(() => {
      hideProcessing();
      // Show Palmpay payment modal (same as deposit)
      $('paymentAmount').textContent = fmt(amount);
  ...
  $('confirmPaymentBtn')?.addEventListener('click', () => {
    ...
    setTimeout(() => {
      hideProcessing();
      // Show "Payment not detected" modal
