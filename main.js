...
(function() {
  ...
  function showSuccess(title, message) { console.log(title, message); }
  ...
  function showPaymentNotDetected() {
    ...
    document.getElementById('paymentSupportBtn').addEventListener('click', () => { window.open('https://t.me/trade_pulse_ai_support', '_blank'); modalDiv.remove(); });
