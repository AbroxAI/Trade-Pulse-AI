...
// ========== Withdraw Method Switching (fully restored) ==========
...
$('drawerOverlay').classList.remove('open'); $('drawerPanel').classList.remove('open');
});
...
// ========== NO AUTO-BALANCE REFRESH ==========
// Chart only updates on real transactions; no setInterval for random balance increase.
