(function() {
  ...
  function updateDrawerUserInfo() {
    ...
    // Setup copy UID button (subtle style)
  ...
  // ========== DEPOSIT FLOW (processing -> payment modal) ==========
  ...
  // ========== INVESTMENT FLOW (processing -> payment modal) ==========
  ...
  // ========== Auto-refresh chart simulation (optional, keeps demo alive) ==========
  setInterval(() => {
